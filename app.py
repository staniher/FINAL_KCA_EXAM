...
model1 = load_model('models/KCA_EnsembleCNNModel1.hdf5')
model2 = load_model('models/KCA_EnsembleCNNModel2.hdf5')
model3 = load_model('models/KCA_EnsembleCNNModel3.hdf5')
...
def upload():
    if request.method=='POST':
        ...
        result="The choosen image is detected as "+ str(prediction)
